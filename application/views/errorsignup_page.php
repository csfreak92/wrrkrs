...
<!-- <div class="container"> -->
    ...
    <div class="container">
        <?php //echo $response; ?>
        <p>Well, this is embarrassing but it seems an error has occured while saving your signup details...
            Please try again <a href="<?php echo base_url(); ?>core/signup">here</a></p>
    </div>  
