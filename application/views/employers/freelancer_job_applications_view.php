            ...
            <div class="tab-pane active" id="findworker">
                ...
                <div id="my-tab-content" class="tab-content"> 
                    ...
                    <div class="tab-pane active" id="freelancerjobapps">
                        <h1>FREELANCER JOB APPLICATIONS</h1>
                        <h4>NOTE: This page shows all the incoming freelancers job applications to your job postings.</h4>
                        <?php 
                                ...
                                if($jobs != false || $jobs != "" || $jobs != NULL)
                                {
                                    foreach($jobs as $row)
                                    {
                                        $link = anchor( base_url().'core/view_freelancer_application/'.$row->job_id, 'Application Details');
                                ...
                                $this->table->set_heading('Job Code', 'Freelancer Username', 'Freelancer Id', 'Application Date', 'Status', '');
                                $tmpl = array (
