    ...
    <div class="container">
        ...
        <div id="my-tab-content" class="tab-content"> 
            <div class="tab-pane active" id="home">
                <ul class="nav nav-tabs" id="tabs" data-tabs="tabs">
                    <li role="presentation" class="active"><a href="<?php echo base_url(); ?>core/searchfreelancers" id="homelink1">Find Freelancers</a></li>
                    <li role="presentation"><a href="<?php echo base_url(); ?>core/searchemployers" id="homelink2">Find Employers</a></li>
                </ul>
                <div class="clearfix"></div>
                <div id="my-tab-content" class="tab-content"> 
