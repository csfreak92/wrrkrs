        ...
        <div id="my-tab-content" class="tab-content"> 
            ...
            <div class="tab-pane active" id="myprofile">
                <ul class="nav nav-tabs" id="tabs" data-tabs="tabs">
                    ...
                    <li role="presentation" class="active"><a href="<?php echo base_url(); ?>core/tests">Tests</a></li>
                ...
                <div id="my-tab-content" class="tab-content"> 
                    ...
                    <div class="tab-pane active" id="tests">
                        <h3>Tests Recommended for You:</h3>
                        <div class="container">
                            <!-- GET BACK HERE LATER!!!!!!!!!!!!! -->
                            <?php 
                                ...
                                $tmpl = array (
                                    'table_open' => '<table border="1" cellpadding="4" cellspacing="0" align="center" id="recommendedtests" name="recommendedtests" class="table table-striped table-bordered">',
                        ...
                        <h3>Tests You have Completed:</h3>
                        <div class="container">
