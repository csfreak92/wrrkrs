    ...
    <div class="container">
        ...
        <div id="my-tab-content" class="tab-content"> 
            ...
            <div class="tab-pane" id="myprofile">
                <ul class="nav nav-tabs" id="tabs" data-tabs="tabs">
                    <li role="presentation"><a href="<?php echo base_url(); ?>core/viewmyprofile" data-toggle="tab">My Online Resume</a></li>
            ...
            <div class="tab-pane active" id="messages">
                <ul class="nav nav-tabs" id="tabs" data-tabs="tabs">
                    ...
                    <li role="presentation" class="active"><a href="<?php echo base_url(); ?>core/notifications">Notifications</a></li>
                </ul>
                <div id="my-tab-content" class="tab-content"> 
